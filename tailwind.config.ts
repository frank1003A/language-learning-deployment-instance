  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        inter: ["Inter"],
        "lilita": ["Lilita-One"],
        "axiforma-semi-bold": ["Axiforma-SemiBold", "sans-serif"],
        "axiforma-thin": ["Axiforma-Thin", "sans-serif"],
        "axiforma": ["Axiforma", "sans-serif"],
        "axiforma-medium-italic": ["Axiforma-MediumItalic", "sans-serif"],
        "axiforma-black": ["Axiforma-Black", "sans-serif"],
        "axiforma-black-italic": ["Axiforma-BlackItalic", "sans-serif"],
        "axiforma-heavy": ["Axiforma-Heavy", "sans-serif"],
        "axiforma-medium": ["Axiforma-Medium", "sans-serif"],
        "axiforma-bold-italic": ["Axiforma-BoldItalic", "sans-serif"],
        "axiforma-extra-bold-italic": ["Axiforma-ExtraBoldItalic", "sans-serif"],
        "axiforma-book": ["Axiforma-Book", "sans-serif"],
        "axiforma-light": ["Axiforma-Light", "sans-serif"],
        "axiforma-thin-italic": ["Axiforma-ThinItalic", "sans-serif"],
        "axiforma-bold": ["Axiforma-Bold", "sans-serif"],
        "axiforma-light-italic": ["Axiforma-LightItalic", "sans-serif"],
        "axiforma-semi-bold-italic": ["Axiforma-SemiBoldItalic", "sans-serif"],
        "axiforma-italic": ["Axiforma-Italic", "sans-serif"],
        "axiforma-book-italic": ["Axiforma-BookItalic", "sans-serif"],
        "axiforma-extra-bold": ["Axiforma-ExtraBold", "sans-serif"],
        "axiforma-heavy-italic": ["Axiforma-HeavyItalic", "sans-serif"],
      },
      boxShadow: {

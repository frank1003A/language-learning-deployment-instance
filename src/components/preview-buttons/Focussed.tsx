export function FocussedPreButton() {
    return(
        <div className="w-[48px] h-[48px] md:w-[64px] md:h-[64px] rounded-full bg-transparent-black-50 p-[4px] flex items-center justify-center">
            <div className="w-[40px] h-[40px] md:w-[56px] md:h-[56px] rounded-full bg-transparent-black-75 p-[4px] flex items-center justify-center">
                <div>

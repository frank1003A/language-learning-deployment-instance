...
const GotoTop = () => {
  ...
  return hideToTop ? undefined : (
    <div
      ...
      onClick={handleTop}
      className={cn(
        "border-primary bg-primary/90 fixed bottom-12 right-2 z-[9999] mx-auto flex max-w-[1440px] select-none items-center rounded border text-2xl text-white backdrop-blur-xl transition-all duration-1000 active:scale-95 active:duration-300 dark:bg-white dark:text-black dark:shadow-[0_0_40px_0_rgba(255,255,255,0.26)] max-[400px]:bottom-16 sm:bottom-16 sm:right-5 sm:text-4xl",
        scrollY > 1000

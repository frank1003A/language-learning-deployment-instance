    ...
    <div className="bg-black fixed inset-0 flex items-center justify-center bg-opacity-50 p-4">
      <div className="relative w-full max-w-[600px] rounded-[4px] bg-[#E9EEF3] p-6 sm:p-8 md:p-[41px_75px_27px_75px]">
        ...
        <div className="flex flex-col items-center gap-8">
          <h2 className="text-center text-xl font-normal leading-[120%] tracking-[1.12px] text-[#595959] sm:text-2xl md:text-[28px]">
          ...
          <p className="w-full max-w-[337px] text-center text-sm font-normal leading-6 text-[#888] sm:text-base">
            This is one of the ways you can earn badges. Take up challenges and
            quests and you can get more!
          </p>
          <button className="flex h-12 w-full items-center justify-center gap-2 rounded-full border border-white bg-[#5D00CC] px-4 py-3 text-sm font-semibold text-white shadow-[inset_0px_-3px_10px_#1F0451,inset_0px_3px_10px_rgba(214,192,255,0.25),0px_6px_4px_rgba(0,0,0,0.25)] sm:w-[262px] sm:text-base">
            Next level
          </button>
        </div>
      </div>
